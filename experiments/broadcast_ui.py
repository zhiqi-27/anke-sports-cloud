"""Disposable real HTTP UI fixture. Synthetic evidence only; no platform calls or shared DB.

Build/start client on 3002, then `uv run python -m experiments.broadcast_ui`.
Open http://localhost:3001/maintenance and enter the local experience.
"""
...
broadcasts.head_probe = lambda url: "reachable"  # Protocol fixture, never actual platform evidence.
