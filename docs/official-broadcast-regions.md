...
更新：2026-09-18。这个清单用于帮助维护者选择版权平台，不能替代对具体场次、具体内容页、付费条件和地区的逐场审核。
...
中国大陆产品入口：NBA 腾讯体育为 `https://sports.qq.com/kbsweb/index.htm#nba`，NBA 咪咕视频为 `https://www.miguvideo.com/p/home/3cd6ba04967742879aaa40bee02a99a6`，F1 腾讯体育为 `https://sports.qq.com/kbsweb/#100360`；英超咪咕视频继续使用既有 `https://www.miguvideo.com/mgs/website/prd/sportsHomePage.html?pageId=0c40bbc85fa345bbba20f8e5fd11a922`。
...
同一场比赛在同一地区有多个版权方时，用户在直播设置按地区和联赛选择首选直播方。偏好以“地区 + 联赛”保存，切换地区不会覆盖其他地区的选择。服务端根据版权矩阵把该版权方的直播产品页直接放进日历；未选择时使用排序最前的已配置产品。用户手动附加链接后，个人日历和 ICS 只交付该手动入口，覆盖官方产品入口。
